...
export default function MobilePage() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-white absolute top-0 left-0 z-99999">
      {/* Header */}
      <div className="flex items-center gap-[9.319px] mt-5 ml-5">
        <div className="h-7 w-7 shrink-0">
          <img alt="" className="size-full" src="/logo/q3x-logo-icon.svg" />
        </div>
        <div className="font-['Schibsted_Grotesk:ExtraBold',_sans-serif] text-[19.96px] font-extrabold leading-[1.2] tracking-[-0.2003px] text-[#2470ff] whitespace-pre shrink-0">
          Q3<span className="text-[#D56BFF]">x</span>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center">
        {/* Main illustration */}
        <img alt="" className="w-[400px] h-[400px]" src="/misc/desktop-only.svg" />
